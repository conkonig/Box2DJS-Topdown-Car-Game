(function () {
    ...
    Physics.prototype.moveRedBox = function (e) {
        ...
        desiredVelY = 0;
        switch( moveState ){
            case 37: desiredVelX = -5; break;
            case 38: desiredVelY = -5;  break;
            case 39: desiredVelX = 5; break;
            case 40: desiredVelY = 5; break;
        }
        ...
        player.ApplyImpulse( {x:impulseX, y:impulseY}, player.GetWorldCenter() );
