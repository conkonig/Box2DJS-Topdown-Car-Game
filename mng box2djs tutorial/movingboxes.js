(function () {
    ...
    function Wheel(details) {
        ...
        fixdef.shape.SetAsBox(this.details.width / 2, this.details.height / 2);
    ...
    function createWorld() {
        ...
        carImage.addEventListener("load", function () {
            ...
            var car = new Car(physics, {
                ...
                image: carImage,
                player: true,
                wheels: [{ 'x': -2.5, 'y': -3.2, 'revolving': true, 'powered': true }, //top left
                { 'x': 2.5, 'y': -3.2, 'revolving': true, 'powered': true }, //top right
                { 'x': -2.5, 'y': 3.2, 'revolving': false, 'powered': false }, //back left
                { 'x': 2.5, 'y': 3.2, 'revolving': false, 'powered': false }]//back right
            }, {
                angle: 180,
                power: 400,
                max_steer_angle: 45,
